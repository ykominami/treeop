...
class Xmla
  ...
  def make_node( node )
    ...
    xpath = node.xpath
    xpath = "" unless xpath
    attr_text = node.attributes['TEXT']
    attr_text = "" unless attr_text

    make_nodex_hier( id , xpath , attr_text ) unless id.empty?
  ...
  def make_nodex_hier( id , xpath , attr_text )
    @hierx.add( id , xpath , attr_text )
  end
