...
//		options = $.extend(true, {}, $.jstree.defaults, options.core);
//		options = $.extend(true, {}, $.jstree.defaults, options.core.plugins);
//		if(opt && opt.plugins) {
		if(opt.core && opt.core.plugins) {
//		    options.plugins = opt.plugins;
		    options.plugins = opt.core.plugins;
		}
 ...
 */
	...
	// $.jstree.defaults.plugins.push("wholerow");
        ...
        if( typeof window.customElements !== 'undefined' ){
          if( typeof window.customElements.define !== 'undefined' ){
            __flag = __flag + 2;
          }
        }
	if( (__flag > 0) && Object && Object.create) {
